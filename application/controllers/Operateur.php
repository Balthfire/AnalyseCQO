...
class Operateur extends CI_Controller
{
    ...
    public function create_action() 
    {
		...
		'valeursql' => $this->input->post('valeursql',TRUE),
	    );
    ...
    public function update($id) 
    {
		...
		'valeursql' => set_value('valeursql', $row->valeursql),
	    );
            $this->load->view('operateur_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
	...
	$this->form_validation->set_rules('valeursql', 'valeursql', 'trim|required');
...
/* Generated by Harviacode Codeigniter CRUD Generator 2017-03-14 15:22:43 */
/* http://harviacode.com */